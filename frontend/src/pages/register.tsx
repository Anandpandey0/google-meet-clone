  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="lg:h-[70vh] h-full w-full flex-wrap lg:w-[30vw] border-2 borde-solid   p-4 px-12 text-center flex flex-col ">
        ...
        <h2 className=" text-2xl mt-4 font-medium">Create a Google Account</h2>
        <h3 className="pt-2">Enter your name</h3>
        <FloatingInput
          type="text"
        ...
        <div className="flex justify-between mt-8 ">
          ...
          <button
            className="py-2 bg-blue-600 text-white px-6 rounded-md ml-auto"
